...
def quantidade_de_impares(valor_inicial, valor_final):
    ...
    ratio = 0
    odds = 0
    while number in range(valor_inicial, valor_final-1):
        ratio = number % 2
        if ratio == 0:
            odds += 1
        number += 1
...
def soma_dos_inteiros(valor1, valor2):
    ...
    res = 0
    num1 = valor1+1  # stands for After
    num2 = 0  # stands for Before

    while num1 in range(valor1, valor2):
        res = res + num1
        num1 += 1
    return res
...
def crescimento_populacional(populacao1, populacao2, crescimento1, crescimento2):
    ...
    while populacao1 < populacao2:
        if crescimento1 == 1:
            break
        populacao1 += populacao1/100*crescimento1
        populacao2 += populacao2/100*crescimento2
        counter += 1
    return counter
