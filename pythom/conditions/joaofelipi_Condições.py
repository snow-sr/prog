...
def testa_lados(a, b, c):
    ...
    #Tinha um código desse em lua, utilizei para um joguinho que fiz, só portei. Percebi a grande semelhança das linguagens!
...
def maior_dia_do_mes(mes, ano):
    ...
    if mes in thirty_months:
        return 30
    elif mes in thirty_one_months:
        return 31
...
def data_valida(data):
    ...
    if day <= 29 and month == 2 and ano_bissexto(year):
        return True
    elif day <= 28 and month == 2:
        return True

    elif day <= 31 and month in thirty_one_months:
        return True

    elif day <=30 and month in thirty_months:
        return True
    else:
        return False
...
def acrescimo_nota_bb(nota_sozinho, nota_com_ajuda):
    ...
    if nota_sozinho < nota_com_ajuda:
        return round(((nota_sozinho - nota_com_ajuda) / 4) * -1, 1)
